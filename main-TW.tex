...
We now show an important property on the interchangebility of feature relabellings and
...
\begin{proof}
  ...
  Similarily, let $\rlR : \SoFF{[k]_L} \rightarrow \SoIF{[k]}$ be the feature relabelling
